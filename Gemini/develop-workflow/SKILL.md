...
> **Instructions for Gemini**: Use your file editing tools to make these modifications directly to the files. Ensure you preserve surrounding yaml/toml structures and comments.
